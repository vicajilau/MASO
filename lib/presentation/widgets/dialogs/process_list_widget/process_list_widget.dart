...
import 'package:maso/presentation/widgets/dialogs/process_list_widget/regular_process_list.dart';
...
class ProcessListWidget extends StatelessWidget {
  ...
  const ProcessListWidget(
      {super.key, required this.maso, required this.onFileChange});

  @override
  Widget build(BuildContext context) {
    switch (maso.processes.mode) {
      case ProcessesMode.regular:
        return RegularProcessList(
          masoFile: maso,
          onFileChange: onFileChange,
        );
      case ProcessesMode.burst:
        return BurstProcessList(
          masoFile: maso,
          onFileChange: onFileChange,
        );
    }
