...
class PriorityExecutionTimeService extends BaseExecutionTimeService {
  ...
  /// Calculates machine execution using burst-based processes with Priority scheduling.
  ///
  /// For burst processes with Priority:
  ...
  /// - CPU bursts are scheduled by arrival time
  /// - I/O bursts are scheduled by arrival time
  ...
  Machine calculateMachineWithBurstProcesses() {
    ...
    // Ready queues for CPU and I/O (FIFO order since no priority)
...
/// Helper class to track thread execution state for Priority scheduling
